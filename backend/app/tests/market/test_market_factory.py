...
def test_yahoo_provider_instantiation():
    ...
    df = provider.fetch_data("^GSPC", start=date(2024,1,1), end=date(2024,1,10))
    assert isinstance(df, type(provider.fetch_data("^GSPC", start=date(2024,1,1), end=date(2024,1,10))))
